...
```bash
curl -fsSL https://github.com/AzimMahmud/dbsh/releases/download/v2.1.0/install.sh | bash
```

**Windows (PowerShell):**

```powershell
powershell -c "iwr -Uri https://github.com/AzimMahmud/dbsh/releases/download/v2.1.0/install.ps1 | iex"
```
...
Manual: download the archive for your platform below, extract, and put `dbsh` (`dbsh.exe`) on your PATH.
...
```bash
# Linux / macOS
UNINSTALL=1 bash -c "$(curl -fsSL https://github.com/AzimMahmud/dbsh/releases/download/v2.1.0/install.sh)"

# Windows
iwr -Uri https://github.com/AzimMahmud/dbsh/releases/download/v2.1.0/install.ps1 -OutFile install.ps1
...
```bash
curl -fsSL https://github.com/AzimMahmud/dbsh/releases/download/v2.1.0/SHA256SUMS | sha256sum -c -
```

## Changelog

See [CHANGELOG.md](https://github.com/AzimMahmud/dbsh/blob/v2.1.0/CHANGELOG.md) for the complete, itemized list.

## Assets

| File | Size | SHA256 |
|------|------|--------|
| dbsh-linux-arm64.tar.gz | 33.53 MB | fc62e2ea9b6b05eba58b92f543d2dddb1768639be247d14e4d6805a8ad24dc96 |
| dbsh-linux-x64.tar.gz | 35.20 MB | 3aa6471d31a5d6e69d54b165e61b8ca2dff7c8b68058b2185154a1bbafed81de |
| dbsh-macos-arm64.tar.gz | 33.76 MB | 948bbaab2260eef3319b39c49c7c8148d8ba09d45fea531175eef57b728d8ff2 |
| dbsh-macos-x64.tar.gz | 35.60 MB | aa05f85952f8daea95890481db978e2deebae3ff173358d5e3ff68c990f9c5d1 |
| dbsh-windows-x64.zip | 34.68 MB | 15423118fe012971731f17bc14d879ceb4a14cb96bad9e071cd2411a0b2a9999 |
| dbsh.2.1.0.nupkg | 38.42 MB | 9a54605eee5a5fab3180a84e82b4cf39d4fa87a279e18ac25c16538ac711f504 |
