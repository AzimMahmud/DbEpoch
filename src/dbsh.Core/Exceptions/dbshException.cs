namespace dbsh.Core.Exceptions;

/// <summary>Base type for all dbsh-specific exceptions. Catch this to handle any tool error.</summary>
public abstract class dbshException : Exception
{
    protected dbshException(string message) : base(message) { }
    protected dbshException(string message, Exception inner) : base(message, inner) { }
}

/// <summary>Thrown when a migration configuration file is missing, invalid, or contains an unsafe value.</summary>
public sealed class MigrationConfigurationException : dbshException
{
...
public sealed class ScriptParseException : dbshException
{
...
public sealed class UnsupportedProviderException : dbshException
{
