namespace DbShift.Core.Exceptions;

/// <summary>Base type for all DbShift-specific exceptions. Catch this to handle any tool error.</summary>
public abstract class DbShiftException : Exception
{
    protected DbShiftException(string message) : base(message) { }
    protected DbShiftException(string message, Exception inner) : base(message, inner) { }
}

/// <summary>Thrown when a migration configuration file is missing, invalid, or contains an unsafe value.</summary>
public sealed class MigrationConfigurationException : DbShiftException
{
...
public sealed class ScriptParseException : DbShiftException
{
...
public sealed class UnsupportedProviderException : DbShiftException
{
