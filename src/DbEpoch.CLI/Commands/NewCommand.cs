    ...
    public override Task<int> ExecuteAsync(CommandContext context, Settings settings)
    {
        ...
        if (isInteractive)
        {
            ...
            var welcome = new Panel(
                new Markup($"[white]This wizard will scaffold a complete [bold {Theme.Primary}]DbEpoch[/] project structure[/]{Environment.NewLine}" +
        ...
        // â”€â”€ Database/Config/migration.json â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        // â”€â”€ Database/Config/environments/*.json â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        // â”€â”€ Migration directories and example migrations â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        // â”€â”€ Templates (plain """ with no interpolation â€” {{NAME}} etc. are literal) â”€â”€
        ...
        // â”€â”€ .gitignore â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        WriteFile(".gitignore", $$"""
            # DbEpoch project scaffold
        ...
        // â”€â”€ .github/workflows/database-migration.yml â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
                ...
                steps:
                  ...
                  - uses: actions/setup-dotnet@v4
                    with:
                      dotnet-version: '10.0.x'
                  - run: dotnet tool restore
                  - run: dbepoch migrate --environment development --yes
                    env:
                ...
                steps:
                  ...
                  - uses: actions/setup-dotnet@v4
                    with:
                      dotnet-version: '10.0.x'
                  - run: dotnet tool restore
                  - run: dbepoch migrate --environment production --approver deploy-bot --yes
                    env:
                      DB_CONNECTION_STRING: ${{ secrets.PROD_DB_CONNECTION_STRING }}
            """.Replace("\r\n", "\n"));

        // .NET local tool manifest so `dotnet tool restore` resolves the `dbepoch` command
        ...
        {
            ConsoleHelper.PrintSuccess("Scaffolded DbEpoch project");
            ...
            var nextSteps = new Panel(
                new Markup(
                    ...
                    $"  {Theme.Step} [grey]Run [bold]dbepoch create --name YourMigration --type schema[/][/]{Environment.NewLine}" +
                    $"  {Theme.Step} [grey]Write your SQL in the generated file[/]{Environment.NewLine}" +
                    $"  {Theme.Step} [grey]Run [bold]dbepoch migrate -c \"$DB_CONNECTION_STRING\"[/][/]"))
                .Border(BoxBorder.Rounded)
                .BorderStyle(Style.Parse(Theme.Muted))
