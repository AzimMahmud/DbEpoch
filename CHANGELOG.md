...
- **README: Updating / Uninstalling sections** — documents re-running the installer to upgrade in place (verified: no duplicate PATH entry, clean binary overwrite) and the new automated uninstall commands.
